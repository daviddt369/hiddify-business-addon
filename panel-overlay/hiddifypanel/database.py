...
def init_no_flask():
    ...
    # Background workers expect a callable/session registry compatible with Flask-SQLAlchemy internals.
    # A plain Session instance breaks model query paths that call `session()`.

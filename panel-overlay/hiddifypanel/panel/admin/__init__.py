...
from .SubscriptionAdmin import SubscriptionAdmin
...
def init_app(app):
    ...
    try:
        with app.app_context():
            business_enabled = bool(hconfig(ConfigEnum.business_enabled))
    except Exception:
    ...
    if business_enabled:
        ...
        flaskadmin.add_view(SubscriptionAdmin(CommercialSubscription, db.session, name="Subscriptions", endpoint="subscriptions"))
    ...
    from .BusinessAdmin import BusinessAdmin

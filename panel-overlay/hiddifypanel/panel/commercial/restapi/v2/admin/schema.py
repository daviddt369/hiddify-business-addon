...
class UserSchema(Schema):
    ...
    max_ips = Integer(
        required=False,
        allow_none=True,
         metadata={"description": "Maximum simultaneous devices or IPs allowed for the user"}
    )
    plan_id = Integer(
        required=False,
        allow_none=True,
         metadata={"description": "Optional commercial tariff assigned to the user"}
    )
    plan_name = String(
        required=False,
        allow_none=True,
         metadata={"description": "Read-only name of the assigned commercial tariff"}
    )
    mode = Enum(UserMode,
                required=False,
                allow_none=True,

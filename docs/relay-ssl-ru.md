...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.1.2/relay-cert/install-dns01.sh)
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.1.2/relay-cert/install-http01.sh)
```

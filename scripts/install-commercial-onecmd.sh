...
# Usage:
#   bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.12.1/scripts/install-commercial-onecmd.sh)
...
curl -fsSL "https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/${ADDON_REF}/commercial-addon/install-addon.sh" \

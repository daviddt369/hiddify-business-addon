...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.2.1/commercial-addon/install-addon.sh)
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.2.1/relay-cert/install-dns01.sh)
```

### Advanced путь: `http-01` через relay ingress

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.2.1/relay-cert/install-http01.sh)
```

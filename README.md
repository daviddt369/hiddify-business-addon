...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.1.9/relay-cert/install-dns01.sh)
```

### Advanced путь: `http-01` через relay ingress

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/daviddt369/hiddify-business-addon/v0.1.9/relay-cert/install-http01.sh)
```
